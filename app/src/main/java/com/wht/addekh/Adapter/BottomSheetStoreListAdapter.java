...
public class BottomSheetStoreListAdapter extends RecyclerView.Adapter<BottomSheetStoreListAdapter.ProductViewHolder> {
    ...
    public BottomSheetStoreListAdapter(Context mCtx, ArrayList<BottomsheetMyStoreListObject> bottomsheetMyStoreListObjects)
    {
        this.mCtx = mCtx;
