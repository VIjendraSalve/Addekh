...
public class MyAdvertismentListAdapter extends RecyclerView.Adapter<MyAdvertismentListAdapter.SingleItemRowHolder> {
    ...
    public MyAdvertismentListAdapter(Context context,
    ...
    public SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_view_my_display, null);
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, @SuppressLint("RecyclerView") int i) {
        ...
        if(singleItem.getIs_active().equals("0")){
            holder.tv_status_of_add.setText("Pending Approval");
        }else if(singleItem.getIs_active().equals("1")){
            holder.tv_status_of_add.setText("Approved");
        }else {
            holder.tv_status_of_add.setText("Rejected");
        }
...
//          System.out.println(TimeUnit.MILLISECONDS.toDays(now.getTime() - past.getTime()) + " days ago");
    ...
    private void showDialog(ArrayList<Advertisment> advertismentArrayList, int position) {
        //Toast.makeText(mContext, ""+advertismentArrayList.get(position).getTemplate_link(), Toast.LENGTH_SHORT).show();
                        ...
                        .withListener(new MultiplePermissionsListener() {
                            ...
                            public void onPermissionsChecked(MultiplePermissionsReport report) {
                                ...
                                if (report.areAllPermissionsGranted()) {
                                    shareResultAsImage(webview, advertismentArrayList.get(position).getTitle(), advertismentArrayList.get(position).getDescription());
                                }
...
//          System.out.println(TimeUnit.MILLISECONDS.toDays(now.getTime() - past.getTime()) + " days ago");
    ...
    public class SingleItemRowHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tv_status_of_add;
        ...
        public SingleItemRowHolder(View view) {
            ...
            this.tv_status_of_add = (TextView) view.findViewById(R.id.tv_status_of_add);
    ...
    private void shareResultAsImage(WebView webView, String examTitle, String examDesc) {
        ...
        emailIntent1.putExtra(Intent.EXTRA_SUBJECT, "Sir, Lalit Dangre");
