...
//            @Field("page_no") int page_no);
    ...
    @FormUrlEncoded
    @POST(IUrls.URL_TEMPLATE_CATEGORY)
    Call<ResponseBody> PostTemplateCategory(
            @Field("user_id") String user_id);
    ...
    @FormUrlEncoded
    @POST(IUrls.URL_Report_ADD)
    public Call<ResponseBody> PostReportAdvertisment(
            @Field("user_id") String user_id,
            @Field("store_advertisements_id") String store_advertisements_id
    );
    ...
    @FormUrlEncoded
    @POST(IUrls.URL_ADMIN_TEMPLATE)
    public Call<ResponseBody> PostAdminTemplate(
            @Field("user_id") String user_id,
            @Field("temp_category_id") String temp_category_id
    );


    @Multipart
    @POST(IUrls.URL_ADD_TEMPLATE_FIELDS)
    public Call<ResponseBody> PostAddTemplateFields(
            @Part("action") RequestBody action,
            @Part("category_id") RequestBody category_id,
            @Part("advt_title") RequestBody advt_title,
            @Part("lat") RequestBody lat,
            ...
            @Part("last_date") RequestBody last_date,
            @Part("store_id") RequestBody store_id,
            @Part("temp_fields") RequestBody temp_fields,
            @Part("user_id") RequestBody user_id,
            @Part("template_id") RequestBody template_id,
            @Part("businessname") RequestBody businessname,
            @Part("email") RequestBody email,
