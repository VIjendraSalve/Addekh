package com.wht.addekh.map_custom_search.adapter;
...
public class AutoCompleteAdapter extends ArrayAdapter<PlaceAutoComplete> {
    ...
    public AutoCompleteAdapter(Context context, ArrayList<PlaceAutoComplete> modelsArrayList, Activity activity) {
