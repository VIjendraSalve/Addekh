...
import com.wht.addekh.Activties.CategorySearchActivity;
...
import com.wht.addekh.Notification.ActivityNotification;
                        ...
                        if (stringCode.equalsIgnoreCase("true")) {
                           ...
                           //     noInternet.setVisibility(View.VISIBLE);
                                ...
                                homeCategoryAdapter = new HomeCategoryAdapter(getContext(),
                                        filteredallCategoryArrayList, new HomeCategoryAdapter.OnItemClickListener() {
                                    @Override
