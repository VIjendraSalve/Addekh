...
public class FragmentFavouritesAds extends Fragment  implements View.OnClickListener,
    ...
    public FragmentFavouritesAds() {
        // Required empty public constructor
    }
    public static  FragmentFavouritesAds newInstanse() {
        FragmentFavouritesAds fragmentFavourites = new FragmentFavouritesAds();
...
//        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_favourites_ads, container, false);
        view = inflater.inflate(R.layout.activity_fragment_fav_ads, container, false);
    ...
    private void getAdvertisment() {
        ...
        Call<ResponseBody> result = api.PostMyFavourite(
                SharedPref.getPrefs(myAdsActivity, IConstant.USER_ID),
                page_count,
                query
        );
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (res) {
                        ...
                        JSONArray jsonArray = jsonObject.getJSONArray("my_fav_advts");
                        // Parsing json
    ...
    public void check_connection() {
        if (CheckNetwork.isInternetAvailable(myAdsActivity))  //if connection available
        {
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(myAdsActivity);
        ...
        mAdapter = new AdvertismentListAdapter(myAdsActivity, filteredadvertismentArrayList);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(myAdsActivity);
