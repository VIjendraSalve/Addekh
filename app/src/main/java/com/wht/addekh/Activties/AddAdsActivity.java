                                ...
                                spnr_store.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                    ...
                                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        if (store_id.equals("-1")) {
                                            Intent intent = new Intent(AddAdsActivity.this, ActivityAddStore.class);
...
//            CategorySearchObject.category_id = object.getString("category_id");
    ...
    private void initViews() {
        ...
        edt_tags = findViewById(R.id.edt_tags);
                        ...
                        .withListener(new MultiplePermissionsListener() {
                            ...
                            public void onPermissionsChecked(MultiplePermissionsReport report) {
                                if (report.areAllPermissionsGranted()) {
                                    ...
                                    /*Intent intent = new Intent(AddAdsActivity.this, TemplateCategoryActivity.class);
                                    startActivity(intent);*/
                                }
