...
import com.wht.addekh.Adapter.HomeCategoryAdapter;
...
public class AdvertismentListActivity extends BaseActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Advertisment");
    ...
    private void getAdvertisment() {
        ...
        Call<ResponseBody> result = api.PostAddvertismentList(
                SharedPref.getPrefs(AdvertismentListActivity.this, IConstant.USER_ID),
                "1",
                "",
                query,
                String.valueOf(SharedPref.getPrefs(AdvertismentListActivity.this,IConstant.MyCurrentLatitude)),
                String.valueOf(SharedPref.getPrefs(AdvertismentListActivity.this,IConstant.MyCurrentLongitude))
        );
                ...
                try {
                    ...
                    if (res) {
                       /* remainingCount = Integer.parseInt(jsonObject.getString("remaining"));
                        ...
                        String stores_path = IUrls.BASE_URL + jsonObject.getString("stores_path");
                        String advt_path = IUrls.BASE_URL + jsonObject.getString("advt_path");
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(AdvertismentListActivity.this);
        ...
        mAdapter = new AdvertismentListAdapter(AdvertismentListActivity.this, filteredadvertismentArrayList);
